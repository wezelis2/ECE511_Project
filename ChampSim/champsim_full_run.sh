...
echo "${BOLD}Running All Traces in dpc3_traces folder with ${N_WARMUP}M warmup and ${N_SIM}M simulation instructions (note that filenames must not be changed from https://hpca23.cse.tamu.edu/champsim-traces/speccpu/index.html)"
echo
